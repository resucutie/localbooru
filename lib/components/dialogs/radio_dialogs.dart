...
final Map<String, ModelDescription> avaiableModels = {
    "danbooru": ModelDescription(name: "Danbooru", description: "A simpler model developed by Danbooru. Gives the fewest accurate results"),
    "joint_tagger_project": ModelDescription(name: "Joint Tagger Project", description: "A model that works great with furry images, but can work great with humanoids"),
    "z3d_e621_convnext": ModelDescription(name: "Z3D-E621-Convnext", description: "A model that can detect pokémon images with good accuracy"),
};
